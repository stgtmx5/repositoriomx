...
RstData.Source="SELECT ctpersona.Sys_PK AS ID, ctpersona.Descripcion AS Descripción  FROM ctpersona;";
...
xBrowsers.SetMethods (Brw, us_brw_dlgctpersona, "AddNew", "Edit", "Delete");

Brw.Caption = "Categorias de personas";
...
function AddNew()
{
if (!LoadFormScript("us_form_dlgCTPersona")) return 0;
return us_form_dlgCTPersona.Dlg_AddNew();
...
{
if (!LoadFormScript("us_form_dlgCTPersona")) return 0;
return us_form_dlgCTPersona.Dlg_Edit(Sys_PK);
...
{
if (!LoadFormScript("us_form_dlgCTPersona")) return 0;
return us_form_dlgCTPersona.Delete(Sys_PK);
