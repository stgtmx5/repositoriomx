...
RstData.Source="SELECT ut_origencontacto.Sys_PK AS ID, ut_origencontacto.uf_Origen AS Origen, ut_origencontacto.uf_Descripcion AS Descripción  FROM ut_origencontacto;";
...
xBrowsers.SetMethods (Brw, us_brw_origencontacto, "AddNew", "Edit", "Delete");

Brw.Caption = "Origenes de contactos";
...
function AddNew()
{
if (!LoadFormScript("us_form_OrigenContacto")) return 0;
return us_form_OrigenContacto.Dlg_AddNew();
...
{
if (!LoadFormScript("us_form_OrigenContacto")) return 0;
return us_form_OrigenContacto.Dlg_Edit(Sys_PK);
...
{
if (!LoadFormScript("us_form_OrigenContacto")) return 0;
return us_form_OrigenContacto.Delete(Sys_PK);
